      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md leading-relaxed">
              The world's most powerful free AI platform. Access 8 premium AI models 
              in one unified interface with unlimited usage. Get superhuman results absolutely free.
            </p>
            <div className="flex gap-4">
              <a href="mailto:support@nexusflowai.com" className="w-10 h-10 bg-surface-secondary hover:bg-neon-green/20 rounded-lg flex items-center justify-center transition-colors group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto:support@nexusflowai.com" className="text-muted-foreground hover:text-neon-purple transition-colors">Contact Us</a></li>
        ...
        <div className="border-t border-border/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">
            © 2024 Nexus Flow AI. All rights reserved.
          </div>
