      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="text-xl font-bold text-neon">Nexus Flow AI</div>
            </div>
            ...
            <div className="flex gap-4">
              <a href="mailto shivshankarrr121@gmail.com" className="w-10 h-10 bg-surface-secondary hover:bg-neon-green/20 rounded-lg flex items-center justify-center transition-colors group">
                <Mail className="w-5 h-5 text-muted-foreground group-hover:text-neon-green transition-colors" />
              </a>
              <a href="https://wa.me/9226193281" className="w-10 h-10 bg-surface-secondary hover:bg-neon-purple/20 rounded-lg flex items-center justify-center transition-colors group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto shivshankarrr121@gmail.com" className="text-muted-foreground hover:text-neon-purple transition-colors">Contact Us</a></li>
        ...
        <div className="border-t border-border/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">
            © 2025 Nexus Flow AI. All rights reserved.
          </div>
